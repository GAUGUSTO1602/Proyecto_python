...
def venta_feria(bd, msg):
    ...
    while True:
        ...
        if opt == 1:
            ...
            verificar_cedula = validar_numero('Ingrese su cedula:\n--> ') #Verificar si el cleinte se encuentra en la base de datos
            ...
            if verificar_cedula in bd["clients"]:
                ...
                while True:
                    ...
                    if 1<= opt_2 <= 3:
                        if opt_2 == 1:
                            while True:
                                opt_5 = None
                                if len(bd["products"]["Comidas"]) == 0: #Si se eliminan todos estos productos
                                    print('')
                                ...
                                if opt_3 - 1 > len(bd["products"]["Comidas"]) or opt_3 <= 0:
                                    ...
                                    while True:
                                        ...
                                        if cantidad < 0:
                                            ...
                                            break
                                        elif cantidad > bd["products"]["Comidas"][opt_3].get_amount(): #Si no queda la cantidad de existencias que solicita el usuario
                                            print('')
                            ...
                            while True:
                                opt_5 = None
                                if len(bd["products"]["Bebidas"]) == 0: #Si se eliminan todos estos productos
                                    print('')
                                    print('Lo sentimos, ya no tenemos disponible este tipo de prodcutos')
                                    print('')
                                    break
                                ...
                                if opt_3 - 1 > len(bd["products"]["Bebidas"]) or opt_3 <= 0:
                                    ...
                                    while True:
                                        ...
                                        if tamano < 0 or tamano > 3:
                                            ...
                                            while True:
                                                if tamano == 1: #Si la bebida es pequeña
                                                    cantidad = validar_numero('Ingrese la cantidad que desea comprar:\n--> ') #Si no queda la cantidad de existencias que solicita el usuario
                                                    if cantidad > bd["products"]["Bebidas"][opt_3].get_little_amount():
                                                        ...
                                                        lista_bebebidas.append([]) #Se gurda el tipo de producto, el tamaño y la cantidad
                                                        ...
                                                        registro_compra = True
                                                        aux_bebida += 1
                                                elif tamano == 2: #Si la bebida es mediana
                                                    cantidad = validar_numero('Ingrese la cantidad que desea comprar:\n--> ') #Si no queda la cantidad de existencias que solicita el usuario
                ...
                if registro_compra == True: #Si el usuario realizo al menos una compra, entra aqui
                    descuento = 0
                    aplicar_descuento = es_narcisista(verificar_cedula) #Verificar numero nercisista
                    if aplicar_descuento == True: #Aplicar descuento
                        print('')
                        print('¡Felcidades! usted recibira un "15%" de descuento en su compra total')
                        print('')
                    total = 0
                    print('----------RECIBO----------') #Imprimir el recibo
                    print('')
                    print('Subtotal:')
                    ...
                    for compra in lista_bebebidas:
                        if compra[1] == 1:
                            ...
                            print('{}: {} * {} = {}'.format(compra[0].get_name(), compra[0].get_middle_price(), compra[2], round(compra[0].get_middle_price() * compra[2], 2))) 
                        else:
                            total += round(compra[0].get_big_price() * compra[2], 2)
                            print('{}: {} * {} = {}'.format(compra[0].get_name(), compra[0].get_big_price(), compra[2], round(compra[0].get_big_price() * compra[2], 2)))
                    ...
                    print('')
                    while True:
                        final_opt = validar_numero('Proceder con la compra:\n1.Si\n2.No\n--> ') #Elimnar recibo si la opción e no
                        if 1 <= final_opt <= 2: #Eliminar recibo si la opción es "no"
                            if final_opt == 2:
                                print('')
                                print('RECIBO ELIMINADO')
                                print('')
                                break
                            else: #Si se procede con la compra, se actualizan las existencias en la base de datos y se añade esa cantidad a la atributo "amount_sell"
                                for compra in lista_comidas:
                                    compra[0].set_amount(compra[1])
                                    compra[0].set_amount_sell(compra[1])
                                for compra in lista_bebebidas:
                                    compra[0].set_amount(compra[2])
                                    compra[0].set_amount_sell(compra[2])
                                    if compra[1] == 1:
                                ...
                                bd["clients"][verificar_cedula].set_status_feria() #Se actualiza el status del cliente
                                bd["clients"][verificar_cedula].set_gastos(total) #Se le añaden los gastos
                                print('')
            ...
            else: #Si el numero de cedula introducido no coincide con alguno de la base de datos
                print('')
